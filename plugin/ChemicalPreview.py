...
def main():
    plugin = nanome.Plugin('2D Chemical Preview', 'A Nanome Plugin to generate 2D images of molecules using RDKit', 'Molecule Image', False, integrations=[Integrations.generate_molecule_image])
